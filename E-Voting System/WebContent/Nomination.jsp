...
<head>
  ...
  <title>E-Voting System : Nomination</title>
   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Nomination for E-Voting</h1>
		
        <!-- Content unit - One column -->
        <div class="column1-unit">
        <form method="post" action="Registration">
        <p>Posts :</p>
          <p>President :<input type="submit" value="File Nomination"/></p>
          <p>Secretary:<input type="submit" value="File Nomination"/></p>
          <p>Manager:<input type="submit" value="File Nomination"/></p>
          <p>Member:<input type="submit" value="File Nomination"/></p>
